...
export default class VoiceOperations extends Component {
  _accessKey = "fSfejZGP7iVOj/QpRtYyybh4MqmldCU5hhkIefqrDjMPug1/B9rltg==" // AccessKey obtained from Picovoice Console (https://console.picovoice.ai/)
  ...
  async componentDidMount() {
    let wakeWordPath = `${RNFS.DocumentDirectoryPath}/pico clock_android.ppn`;
    let contextPath = `${RNFS.DocumentDirectoryPath}/SeeThrough-Test_en_android_v2_2_0.rhn`;

    await RNFS.copyFileAssets("pico clock_android.ppn", wakeWordPath);
    await RNFS.copyFileAssets("SeeThrough-Test_en_android_v2_2_0.rhn", contextPath);
      ...
      <View style={styles.container}>
        ...
        {this.state.isError ? (
          ...
          <View style={{ flex: 0.35, justifyContent: "center" }}>
            ...
            />
            <Text style={styles.instructions} onPress={() => this.setState({isListening: true})}>Say 'PicoClock'!</Text>
          </View>
        )}
